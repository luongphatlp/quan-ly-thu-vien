...
public class Sach {
    ...
    public Sach(){}
    public Sach(String masach,String tensach,String matheloai,String madocgia,String manxb,String namxuatban){
        this.masach=masach;
        this.tensach=tensach;
        this.matheloai=matheloai;
        this.matacgia=madocgia;
        this.manxb=manxb;
    ...
    public void setMaDocGia(String madocgia){this.matacgia=madocgia;}
    ...
    public void nhap(){
        ...
        System.out.println("Nhap ma doc gia: "); matacgia=sc.nextLine();
    ...
    public void xuat(){
        System.out.printf("| %-10s | %-25s | %-10s | %-10s | %-10s | %-5s |",masach, tensach, matheloai , matacgia ,manxb ,namxuatban);
    }
}
